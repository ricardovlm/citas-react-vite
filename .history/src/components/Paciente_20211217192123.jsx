const Paciente = ({hey, paciente}) => {
    ...
    return (
        <div className="bg-white shadow-md rounded- py-10 px-5 md:ml-5 mb-5">
            ...
            <button
                type="button"
                className="px-10 py-2 text-sm text-indigo-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2"
                >Editar</button>
